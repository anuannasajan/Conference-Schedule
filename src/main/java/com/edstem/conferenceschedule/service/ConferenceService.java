...
public class ConferenceService {
    ...
    @Autowired
    public ConferenceService(ConferenceRepository conferenceRepository, ScheduleRepository scheduleRepository){
        this.conferenceRepository = conferenceRepository;
        this.scheduleRepository = scheduleRepository;
    }
    public ConferenceResponse addANewConference(ConferenceRequest conferenceRequest) {
        List<String> reqFoodOptions = conferenceRequest.getFoodOptions().stream().toList();
        List<String> reqHotelOptions = conferenceRequest.getHotelOptions().stream().toList();
        Conference conference = Conference.builder()
                ...
                .foodOptions(reqFoodOptions)
                .hotelOptions(reqHotelOptions)
        ...
        return ConferenceResponse.builder()
                ...
                .foodOptions(saved.getFoodOptions().stream().toList())
                .hotelOptions(saved.getHotelOptions().stream().toList())
                .codeOfConduct(saved.getCodeOfConduct())
                .schedules(null)
                .build();
    }
